...
const NewArrival = () => {
  ...
  const [scrollLeft, setScorllLeft] = useState(false);
  ...
  return (
    <section className="py-16 px-4 lg:px-0">
      <div className="container mx-auto text-center mb-10 relative">
        <h2 className="text-3xl font-bold mb-4">Explore New Arrivlas</h2>
        <p className="text-lg text-gray-600 mb-8">
          Discover thee latest styles off the runway, freshly added to keep your
